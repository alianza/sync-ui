...
export const appMenuItems = [
  { href: "/dashboard", label: "Dashboard", exact: true, icon: DashboardIcon },
  { href: "/dashboard/listings", label: "Listings", icon: ScrollTextIcon },
  { href: "/dashboard/clients", label: "Klanten", icon: UsersIcon },
];
